...
class AbstractEvent(object, metaclass=_AbstractEventMeta):
    __slots__ = ['tick', 'data']
    ...
    def __lt__(self, other):
        if self.tick < other.tick: return True
        elif self.tick > other.tick: return False
